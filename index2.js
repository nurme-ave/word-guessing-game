...
let animals = ['polar bear', 'fox', 'white polar white bear'];
// let animals = [
...
//   joinSplitReplaceRandomWord = splitReplaceRandomWord.join(" ");
//   console.log(joinSplitReplaceRandomWord);
